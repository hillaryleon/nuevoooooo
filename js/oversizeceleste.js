...
const producto = {
    id: 3, // Asigna un ID único al producto
    nombre: 'OVERSIZE DISEÑO DE MUÑECO - CELESTE',
    ...
    precio: 100.00, // Asegúrate de que este precio sea el correcto
    foto: 'imagenes/oversizeceleste.png' // Ruta de la imagen del producto
};
